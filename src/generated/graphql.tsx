...
export type GetFuzzyPokemonQuery = { __typename?: 'Query', getFuzzyPokemon: Array<{ __typename?: 'Pokemon', species: string, color: string, backSprite: string, types: Array<string>, key: PokemonEnum, shinySprite: string, shinyBackSprite: string, sprite: string, weight: number }> };
...
/**
 * __useGetFuzzyPokemonQuery__
 *
 * To run a query within a React component, call `useGetFuzzyPokemonQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetFuzzyPokemonQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetFuzzyPokemonQuery({
 *   variables: {
 ...
 * });
 */
export function useGetFuzzyPokemonQuery(baseOptions: Apollo.QueryHookOptions<GetFuzzyPokemonQuery, GetFuzzyPokemonQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetFuzzyPokemonQuery, GetFuzzyPokemonQueryVariables>(GetFuzzyPokemonDocument, options);
      }
export function useGetFuzzyPokemonLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetFuzzyPokemonQuery, GetFuzzyPokemonQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetFuzzyPokemonQuery, GetFuzzyPokemonQueryVariables>(GetFuzzyPokemonDocument, options);
        }
export type GetFuzzyPokemonQueryHookResult = ReturnType<typeof useGetFuzzyPokemonQuery>;
export type GetFuzzyPokemonLazyQueryHookResult = ReturnType<typeof useGetFuzzyPokemonLazyQuery>;
export type GetFuzzyPokemonQueryResult = Apollo.QueryResult<GetFuzzyPokemonQuery, GetFuzzyPokemonQueryVariables>;